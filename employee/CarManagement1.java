 ...
 * @author malsh
 */
public class CarManagement1 extends javax.swing.JFrame {

    /**
     * Creates new form CarManagement
     */
    public CarManagement1() {
        initComponents();
...
if (status.equals("unsold") ) {
    ...
    txtsoldprice.setEditable(true);           // aloow to edit
}
...
private void calculateProfit() {
    ...
    try {
    DefaultTableModel dt = (DefaultTableModel) cars_table.getModel(); // Replace 'cars_table' with your JTable name
    ...
    while (rs.next()) {
        ...
        // Add each column value from the 'cars' table
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtdos, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 390, 160, -1));
        ...
        getContentPane().add(btndelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 360, 100, 45));
...
try {
    ...
    pst.executeUpdate(); // ✅ Execute the first insert
...
txtstatus.setText(status);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CarManagement1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CarManagement1().setVisible(true);
            }
        });
    }
